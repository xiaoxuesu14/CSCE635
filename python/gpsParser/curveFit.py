...
'''
vxu = scipy.interpolate.splev(t,xtck,der=1)
vyu = scipy.interpolate.splev(t,ytck,der=1)
# curve fit to the velocity
vxtck = scipy.interpolate.splrep(t,vxu,k=3,s=1.0)
vytck = scipy.interpolate.splrep(t,vyu,k=3,s=1.0)
vxs = scipy.interpolate.splev(ti,vxtck,der=0)
vys = scipy.interpolate.splev(ti,vytck,der=0)
ax = scipy.interpolate.splev(ti,vxtck,der=1)
ay = scipy.interpolate.splev(ti,vytck,der=1)
'''
