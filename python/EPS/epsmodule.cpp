...
static PyObject * eps_pack_gps(PyObject *self, PyObject *args){
  long lat=0,lon=0;
  float t = 0.0;
...
static PyObject * eps_pack_control(PyObject *self, PyObject *args){
  float rudd, thro;
...
static PyObject * eps_pack_command(PyObject *self, PyObject *args){
  float heading, speed;
 ...
 */
static PyObject * eps_pack_set_pid(PyObject *self, PyObject *args){
  float heading, speed;
  uint8_t ch;
  float KP, KI, KD;
 ...
 */
static PyObject * eps_unpack_gps(PyObject *self, PyObject *args){
  const char* byt;
  int len = MSG_GPS_LEN;
 ...
 */
static PyObject * eps_unpack_control(PyObject *self, PyObject *args){
  const char* byt;
 ...
 */
static PyObject * eps_unpack_command(PyObject *self, PyObject *args){
  const char* byt;
 ...
 */
static PyObject * eps_unpack_set_pid(PyObject *self, PyObject *args){
  const char* byt;
...
static PyObject * eps_parse_buffer(PyObject *self, PyObject *args){
  const char* buffy;
  int len;
...
static PyObject * eps_message_gps(PyObject *self, PyObject *args){
  return Py_BuildValue("i",MSG_GPS);
}

/** Return the message ID for control message */
static PyObject * eps_message_control(PyObject *self, PyObject *args){
  return Py_BuildValue("i",MSG_CONTROL);
}

/** Return the message ID for control message */
static PyObject * eps_message_command(PyObject *self, PyObject *args){
  return Py_BuildValue("i",MSG_COMMAND);
}

/** Return the message ID for set_pid message */
static PyObject * eps_message_set_pid(PyObject *self, PyObject *args){
  return Py_BuildValue("i",MSG_SET_PID);
}

static PyMethodDef EpsMethods[] = {
  {"pack_gps",  eps_pack_gps, METH_VARARGS,"Pack a GPS message."},
  {"pack_control",  eps_pack_control, METH_VARARGS,"Pack a control message."},
  {"pack_command",  eps_pack_command, METH_VARARGS,"Pack a command message."},
  {"pack_set_pid",  eps_pack_set_pid, METH_VARARGS,"Pack a set_pid message."},
  {"unpack_gps",  eps_unpack_gps, METH_VARARGS,"Unpack a GPS message."},
  {"unpack_control",  eps_unpack_control, METH_VARARGS,"Unpack a control message."},
  {"unpack_command",  eps_unpack_command, METH_VARARGS,"Unpack a command message."},
  {"unpack_set_pid",  eps_unpack_set_pid, METH_VARARGS,"Unpack a set_pid message."},
  {"parse_buffer",  eps_parse_buffer, METH_VARARGS,"Parse a buffer into messages"},
  {"message_gps",  eps_message_gps, METH_VARARGS,"Get the message ID for GPS message"},
  {"message_control",  eps_message_control, METH_VARARGS,"Get the message ID for control message"},
  {"message_command",  eps_message_command, METH_VARARGS,"Get the message ID for command message"},
  {"message_set_pid",  eps_message_set_pid, METH_VARARGS,"Get the message ID for set_pid message"},
